...
namespace GMlib {
  ...
  PSurfPointsVisualizer<T,n>::PSurfPointsVisualizer() : _size(3.0f), _color(GMcolor::blueViolet()), _no_points(0) {
  ...
  PSurfPointsVisualizer<T,n>::PSurfPointsVisualizer(const PSurfPointsVisualizer<T,n>& copy)
    : PSurfVisualizer<T,n>(copy), _size(copy._size), _color(GMcolor::blueViolet()), _no_points(0) {
  ...
  template <typename T, int n>
  inline
  void PSurfPointsVisualizer<T,n>::update() {
