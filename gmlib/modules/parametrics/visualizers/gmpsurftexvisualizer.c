...
namespace GMlib {
  ...
  void PSurfTexVisualizer<T,n>::setTexture(const GL::Texture& tex) {
    ...
    _tex = tex;
    _tex.texParameteri(GL_TEXTURE_MIN_FILTER,GL_LINEAR);
    _tex.texParameteri(GL_TEXTURE_MAG_FILTER,GL_LINEAR);
    _tex.texParameteri(GL_TEXTURE_WRAP_S,GL_REPEAT);
    _tex.texParameteri(GL_TEXTURE_WRAP_T,GL_REPEAT);
  }
  ...
  template <typename T, int n>
  inline
  void PSurfTexVisualizer<T,n>::update() {
    ...
    PSurfVisualizer<T,n>::fillNMap( _nmap, normals, _closed[0], _closed[1] );
  }
  ...
  template <typename T, int n>
  inline
  void PSurfTexVisualizer<T,n>::_init() {
