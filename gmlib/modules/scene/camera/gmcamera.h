...
//    _matrix.setRow( nz, 2 );
//    _matrix.setRow( nw, 3 );
    _matrix[0][0] =-x(0); _matrix[0][1] =-x(1); _matrix[0][2] =-x(2); _matrix[0][3] =  x*p;
    _matrix[1][0] = y(0); _matrix[1][1] = y(1); _matrix[1][2] = y(2); _matrix[1][3] =-(y*p);
    _matrix[2][0] =-z(0); _matrix[2][1] =-z(1); _matrix[2][2] =-z(2); _matrix[2][3] =  z*p;
