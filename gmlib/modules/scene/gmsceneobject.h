...
#include "visualizers/gmsurroundingspherevisualizer.h"
...
//      Angle a=0);
    ...
    virtual void                        move(double d, bool propagate = true);
  ...
  protected:
    ...
    SurroundingSphereVisualizer*        _sphere_vis;
  ...
  inline const HqMatrix<float,3>& SceneObject::getMatrixToScene() const { return _matrix_scene; }
  inline const HqMatrix<float,3>& SceneObject::getMatrixToSceneInverse() const { return _matrix_scene_inv; }
  ...
  inline bool SceneObject::isLocal() const      { return _local_obj; }
  inline void SceneObject::setLocal( bool lo )  { _local_obj = lo; }


  inline const Point<float,3>& SceneObject::getLockPos() const {
    if(_lock_object)
  ...
  inline double SceneObject::getLockDist() const {
    if(_locked)
  ...
  inline bool SceneObject::isLocked() const { return _locked; }
  ...
  inline
  void SceneObject::basisChange( const Vector<float,3>& x, const Vector<float,3>& y, const Vector<float,3>& z, const Point<float,3>& p ) {

//    static Point<float,4> nx, ny, nz, np;
...
//    _matrix.setCol( np, 3 );
    ...
    _matrix.setColHq( z, 0 );
    _matrix.setColHq( x, 1 );
    _matrix.setColHq( y, 2 );
    _matrix.setColHq( p, 3 );
  }
   ...
   *  Pending Documentation
   */
  inline       Array<SceneObject*>& SceneObject::getChildren()       { return _children; }
  inline const Array<SceneObject*>& SceneObject::getChildren() const { return _children; }
   ...
   *  Pending Documentation
   */
  inline const HqMatrix<float,3>& SceneObject::getMatrixGlobal() const { return _present; }
   ...
   *  Pending Documentation
   */
  inline int SceneObject::getTypeId() const { return _type_id; }
   ...
   *  Pending Documentation
   */
  inline bool SceneObject::isSelected() const { return _selected; }
   ...
   *  Pending Documentation
   */
  inline bool SceneObject::isVisible() const { return _visible; }
   ...
   *  Pending Documentation
   */
  inline void SceneObject::selectEvent( int /* selector_id */ ) {}
   ...
   *  Pending Documentation
   */
  inline void SceneObject::setParent( SceneObject* obj ) { _parent = obj; }
   ...
   *  Pending Documentation
   */
  inline void SceneObject::setDerived( SceneObject* obj ) { _derived = obj; }
   ...
   *  Pending Documentation
   */
  inline bool SceneObject::toggleVisible() { return _visible =! _visible; }

  inline const Color&  SceneObject::getColor() const { return _color; }
  inline       Color&  SceneObject::getColor()       { return _color; }
  inline void          SceneObject::setColor( const Color& c ) { _color = c; }

  inline const Material& SceneObject::getMaterial() const { return _material; }
  inline       Material& SceneObject::getMaterial()       { return _material; }
  inline void            SceneObject::setMaterial( const Material& m ) { _material = m; }

  inline bool          SceneObject::isLighted() const          { return _lighted; }
  inline void          SceneObject::setLighted( bool lighted ) { _lighted = lighted; }


  /*! Array<Visualizer*>& SceneObject::getVisualizers()
   *  Pending Documentation
   */
  inline       Array<Visualizer*>& SceneObject::getVisualizers()       { return _visualizers; }
  inline const Array<Visualizer*>& SceneObject::getVisualizers() const { return _visualizers; }
