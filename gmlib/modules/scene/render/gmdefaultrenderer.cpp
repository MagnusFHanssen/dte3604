...
namespace GMlib {
  ...
  void DefaultRenderer::initRenderProgram() {
    ...
    std::string fs_src(
          ...
          "\n"
          "  fragColor = texture( u_tex, ex_tex_coord );\n"
          "\n"
          "  if( res > 0.0 )\n"
          "   fragColor = u_select_color;\n"
          "\n"
//          "  float bah = texture( u_tex_selected, ex_tex_coord ).b; \n"
//          "  if( bah > 0.0 )\n"
//          "   fragColor = vec4( bah, 0.0, 0.0, 1.0 );\n"
//          "   fragColor = vec4( res, 0.0, 0.0, 1.0 );\n"
//          "   fragColor = vec4( res_y, 0.0, 0.0, 1.0 );\n"
//          "   fragColor = vec4( 0.0, res_y, 0.0, 1.0 );\n"
          "}\n"
          );
