...
namespace GMlib {
  ...
  private:
    ...
    void                          _storeSelectorValuePointers( DVector<Point<T,3> >& c );
    void                          _storeSelectorValuePointers( DVector<Vector<T,3> >& c );
    void                          _storeSelectorValuePointers( DMatrix<Point<T,3> >& c );
    void                          _storeSelectorValuePointers( DMatrix<Vector<T,3> >& c );
