...
namespace GMlib {
  ...
  VisualizerStdRep *VisualizerStdRep::_s_instance = nullptr;
  ...
  void VisualizerStdRep::renderGeometry( const SceneObject* obj, const Renderer* renderer, const Color& color ) const {
    ...
    _prog.bind(); {
      ...
      _bo_cube.bind();
      _bo_cube.enableVertexArrayPointer( vertice_loc, 3, GL_FLOAT, GL_FALSE, 0, static_cast<const GLvoid*>(nullptr) );
      _bo_cube_indices.bind();
        GL_CHECK(::glDrawElements( GL_QUADS, 24, GL_UNSIGNED_SHORT, nullptr ));
  ...
  void VisualizerStdRep::render(const HqMatrix<float,3> &mvmat,
    ...
    _prog.bind(); {
      ...
      _bo_cube.bind();
      _bo_cube.enableVertexArrayPointer( vert_loc, 3, GL_FLOAT, GL_FALSE, 0, static_cast<const GLvoid*>(nullptr) );
      ...
      _bo_cube_frame_indices.bind(); {
        ...
        GL_CHECK(::glDrawElements( GL_LINES, 2, GL_UNSIGNED_SHORT, static_cast<const GLvoid*>(nullptr) ));
